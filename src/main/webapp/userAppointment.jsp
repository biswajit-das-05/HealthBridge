        ...
        <div class="col-md-6">
            <div class="card paint-card">
                <div class="card-body">
                    ...
                    <form class="row g-3" action="${pageContext.request.contextPath}/addAppointment" method="post">

                        <input type="hidden" name="userid" value="${userObj.id }">

                        <div class="col-md-6">
                            <%--@declare id="inputemail4"--%><label for="inputEmail4" class="form-label">Full Name</label> <input
